...
class _RideDetailsScreenState extends State<RideDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Get.find<PusherRideController>().subscribePusher();
    });
  }
              ...
              bottomSheet: controller.isLoading
                  ...
                  : AnimatedPadding(
                      ...
                      child: DraggableScrollableSheet(
                        ...
                        expand: false,
                        initialChildSize:
                            0.4, // initial height (percentage of screen height)
                        minChildSize:
                            0.3, // minimum height when fully collapsed
                        maxChildSize: 0.5, // maximum height when fully expanded
