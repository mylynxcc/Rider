...
class _AppDrawerScreenState extends State<AppDrawerScreen> {
  ...
  Widget build(BuildContext context) {
    String name = Get.find<ApiClient>().sharedPreferences.getString(
        ...
        '';
    String userName = Get.find<ApiClient>().getCurrencyOrUsername(
      isCurrency: false,
      isSymbol: false,
    );
                                  ...
                                  return Column(
                                    children: [
                                      DrawerItem(
                                        ...
                                        iconColor:
                                            MyColor.getRideSubTitleColor(),
                                        onTap: () {
                                          Get.toNamed(
                                            RouteHelper.rideScreen,
