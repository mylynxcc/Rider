...
class DriverReviewHistoryScreen extends StatefulWidget {
  ...
  @override
  State<DriverReviewHistoryScreen> createState() =>
      _DriverReviewHistoryScreenState();
}
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      '${MyStrings.averageRatingIs.tr} ${double.tryParse(controller.driver?.avgRating ?? "0") ?? 0}'
                          .toCapitalized(),
                    ...
                    if (isReviewTab) ...[
                      ...
                      Align(
                        ...
                        child: Text(
                          isReviewTab ? MyStrings.riderReviews.tr : "".tr,
                    ...
                    Expanded(
                      child:
                          isReviewTab ? DriverReviewList() : CarInformation(),
                    ),
                  ],
                ),
              ),
