                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          summaryRow(
                            ...
                            amount:
                                "${controller.defaultCurrencySymbol}${Converter.formatNumber(controller.ride.amount ?? '0')}",
                          ),
                          const CustomDivider(
                          ...
                          summaryRow(
                            ...
                            widget: GestureDetector(
                              ...
                              child: controller.tipsController.text.isEmpty
                                  ? Icon(Icons.add)
                                  : Text(
                                      "${controller.defaultCurrencySymbol}${Converter.formatNumber(controller.tipsController.text, precision: 2)}",
                          ...
                          summaryRow(
                            ...
                            amount:
                                "${controller.defaultCurrencySymbol}${Converter.sum(Converter.calculateDiscount(controller.ride.amount ?? '0', couponController.selectedCoupon.amount ?? '0', isPercentageCalculation: couponController.selectedCoupon.discountType == AppStatus.DISCOUNT_PERCENT), controller.tipsController.text)}",
                            isTitleBold: true,
                          ),
