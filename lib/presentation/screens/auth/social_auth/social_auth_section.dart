      ...
      builder: (controller) {
        return Column(
          children: [
            Row(
              children: [
                if (controller.authRepo.apiClient.isGoogleLoginEnable() ==
                    true) ...[
                  Expanded(
                    child: InkWell(
                      onTap: () {
                ...
                if (controller.authRepo.apiClient.isAppleLoginEnable() ==
                        true &&
                    Platform.isIOS) ...[
                  Expanded(
                    child: InkWell(
            ...
            if (controller.authRepo.apiClient.isGoogleLoginEnable() == true ||
                controller.authRepo.apiClient.isAppleLoginEnable() == true) ...[
