                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (controller.model.data?.myTickets?.status !=
                                  '3')
                                CustomCircleAnimatedButton(
                                  onTap: () {
                                    loggerX(
                                      controller.model.data?.myTickets?.status,
                                    );
                                    AppDialog().warningAlertDialog(
                                      context,
                                      msgText:
                                          MyStrings.closeTicketWarningTxt.tr,
                                      () {
                                        Get.back();
                                        controller.closeTicket(
                                          controller.model.data?.myTickets?.id
                                                  .toString() ??
                                              '-1',
                                        );
                                        Get.back();
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: MyColor.getCardBgColor(),
                            border: Border.all(
                              color: MyColor.borderColor.withValues(alpha: 0.8),
                              width: 1,
                              strokeAlign: BorderSide.strokeAlignOutside,
                            ),
                          ),
