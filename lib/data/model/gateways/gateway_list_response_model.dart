...
GatewayListResponseModel gatewayListResponseModelFromJson(String str) =>
    GatewayListResponseModel.fromJson(json.decode(str));

String gatewayListResponseModelToJson(GatewayListResponseModel data) =>
