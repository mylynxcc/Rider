...
CreateRideResponseModel createRideResponseModelFromJson(String str) =>
    CreateRideResponseModel.fromJson(json.decode(str));

String createRideResponseModelToJson(CreateRideResponseModel data) =>
