...
BidListResponseModel bidListResponseModelFromJson(String str) =>
    BidListResponseModel.fromJson(json.decode(str));

String bidListResponseModelToJson(BidListResponseModel data) =>
